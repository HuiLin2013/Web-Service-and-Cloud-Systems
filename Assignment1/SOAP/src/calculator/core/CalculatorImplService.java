 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://core.calculator/", wsdlLocation = "http://localhost:8080/WS/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://core.calculator/", "CalculatorImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS/Calculator?wsdl");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://core.calculator/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://core.calculator/", "CalculatorImplPort"), Calculator.class, features);
    }
