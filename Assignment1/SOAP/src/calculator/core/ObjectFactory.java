 ...
 * generated in the calculator.core package. 
...
public class ObjectFactory {
    ...
    private final static QName _Add_QNAME = new QName("http://core.calculator/", "add");
    private final static QName _Mul_QNAME = new QName("http://core.calculator/", "mul");
    private final static QName _Div_QNAME = new QName("http://core.calculator/", "div");
    private final static QName _DivResponse_QNAME = new QName("http://core.calculator/", "divResponse");
    private final static QName _SubResponse_QNAME = new QName("http://core.calculator/", "subResponse");
    private final static QName _AddResponse_QNAME = new QName("http://core.calculator/", "addResponse");
    private final static QName _MulResponse_QNAME = new QName("http://core.calculator/", "mulResponse");
    private final static QName _Sub_QNAME = new QName("http://core.calculator/", "sub");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: calculator.core
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "mul")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "div")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "divResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "subResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "mulResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://core.calculator/", name = "sub")
